...
// PermissionPolicy controls the level of tool-use autonomy granted to the agent.
type PermissionPolicy string

const (
	// PermReadOnly restricts the agent to read-only operations; no file writes or shell commands.
	PermReadOnly PermissionPolicy = "read-only"
